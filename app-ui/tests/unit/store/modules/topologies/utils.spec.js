...
test('create tree', () => {
  ...
  const categories = [
    ...
    { _id: '5fc6830717eeeb7d550c4a96', name: 'Folder #2', parent: '5fc682fc5c1656652b0ec426' },
    { _id: '5fc6830d5c1656652b0ec427', name: 'Folder #3', parent: '5fc6830717eeeb7d550c4a96' },
  ...
  const result = [
    ...
    { id: '5fc6832fb495161c6e5eab46', name: 'Folder #4', type: 'CATEGORY', parent: null, children: [] },
    {
