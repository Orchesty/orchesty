    ...
    <v-list dense>
      ...
      <v-list-item link @click="$refs.import.click()">
        ...
        <v-list-item-title class="d-flex justify-space-between align-center">
          <span class="mr-2">{{
            $t(`contextMenu.folder.importTopology`)
          }}</span>
        ...
        this.folderMenuItems = [
          {
            ...
            onClick: () =>
              this.events.emit(EVENTS.MODAL.FOLDER.CREATE, {
                topology: this.folder,
              }),
          },
          {
            ...
            icon: "account_tree",
            onClick: () =>
              this.events.emit(EVENTS.MODAL.TOPOLOGY.CREATE, {
                topology: this.folder,
              }),
          },
          {
            ...
            icon: "edit",
            onClick: () =>
              this.events.emit(EVENTS.MODAL.FOLDER.EDIT, {
                topology: this.folder,
              }),
          },
          {
            ...
            icon: "mdi-delete",
            onClick: () =>
              this.events.emit(EVENTS.MODAL.FOLDER.DELETE, {
                topology: this.folder,
              }),
          },
        ]
