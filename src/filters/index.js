...
export const internationalFormat = (date) => {
  return moment(date).add(moment().utc().utcOffset(), 'minutes').format('DD.MM.YYYY HH:mm:ss ')
}

export const internationalFormatTimestamp = (date) => {
  return moment.unix(date).add(moment().utc().utcOffset()).format('DD.MM.YYYY HH:mm:ss ')
}
