...
/**
 * Class ZohoSyncUpdateContactMapperTest
 *
 * @package Tests\Unit\AppBundle\Model\Systems\Impl\Zoho\Mapper
 */
final class ZohoSyncUpdateContactMapperTest extends ConnectorTestCaseAbstract
{
    ...
    {
        $connector = $this->ownContainer->get('hbpf.custom_node.zoho-sync-update-contact-mapper');
