...
use CleverConnectors\AppBundle\Model\Systems\Impl\Zapier\Connector\ZapierCreateSubscriberConnector;
 ...
 */
class ZapierCreateSubscriberConnectorTest extends ConnectorTestCaseAbstract
{
    ...
    public function testProcessAction(): void
    {
        ...
        $systemInstall->setSettings([
            ZapierSystem::CREATE_WEBHOOK_URL => 'http://webhook.url',
        ]);
        ...
        $connector = new ZapierCreateSubscriberConnector($zapierSystem, $curl, $dm);
