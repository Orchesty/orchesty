 ...
 */
class SalesforceAppMapFieldsConnector extends SalesForceAppConnectorAbstract implements ConnectorInterface
{
    ...
    public function processAction(ProcessDto $dto): ProcessDto
    {
        ...
        $response = $this->sendRequest($dto, $systemInstall, $requestDto);
        if (is_null($response)) {
            return $dto;
        }
