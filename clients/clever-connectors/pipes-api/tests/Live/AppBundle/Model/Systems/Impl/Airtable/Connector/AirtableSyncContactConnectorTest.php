 ...
 */
final class AirtableSyncContactConnectorTest extends DatabaseTestCaseAbstract
{
    ...
    public function testProcessBatch(): void
    {
        ...
        $connector = $this->container->get('hbpf.connector.airtable-sync-contact-connector');
