 ...
 */
final class SalesforceDeletedContactConnectorTest extends ConnectorTestCaseAbstract
{
    ...
    public function testProcessBatch(): void
    {
        ...
        $connector  = $this->container->get('hbpf.connector.salesforce-deleted-contact-connector');
