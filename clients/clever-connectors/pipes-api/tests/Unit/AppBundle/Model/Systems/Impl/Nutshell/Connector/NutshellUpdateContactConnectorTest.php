...
use CleverConnectors\AppBundle\Model\Systems\Impl\Nutshell\Connector\NutshellUpdateContactConnector;
...
final class NutshellUpdateContactConnectorTest extends ConnectorTestCaseAbstract
{
    ...
    /**
     * @return NutshellUpdateContactConnector
     */
    private function getConnectorMock(): NutshellUpdateContactConnector
    {
        ...
        return new NutshellUpdateContactConnector($this->getSystemMock(), $documentManager, $curlManager);
    }
