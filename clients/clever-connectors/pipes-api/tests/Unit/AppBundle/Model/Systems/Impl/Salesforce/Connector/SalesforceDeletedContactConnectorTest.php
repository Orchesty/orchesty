...
use CleverConnectors\AppBundle\Model\Systems\Impl\Salesforce\Connector\SalesforceDeletedContactConnector;
...
/**
 * Class SalesforceDeletedContactConnectorTest
 *
 * @package Tests\Unit\AppBundle\Model\Systems\Impl\Salesforce\Connector
 */
final class SalesforceDeletedContactConnectorTest extends KernelTestCaseAbstract
{
    ...
    public function testProcessBatch(): void
    {
        ...
        /** @var SalesforceDeletedContactConnector $syncConn */
    ...
    /**
     * @return PHPUnit_Framework_MockObject_MockObject|SalesforceDeletedContactConnector
     */
    private function mockSync()
    {
        ...
        $syncConn = $this->getMockBuilder(SalesforceDeletedContactConnector::class)
