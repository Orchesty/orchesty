...
/**
 * Class NutshellDeleteContactMapperTest
 *
 * @package Tests\Unit\AppBundle\Model\Systems\Impl\Nutshell\Mapper
 */
final class NutshellDeleteContactMapperTest extends ConnectorTestCaseAbstract
{
    ...
    {
        $connector = $this->container->get('hbpf.custom_node.nutshell-delete-contact-mapper');
