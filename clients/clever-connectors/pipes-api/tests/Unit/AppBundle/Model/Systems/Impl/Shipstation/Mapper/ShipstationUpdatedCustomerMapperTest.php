...
/**
 * Class ShipstationUpdatedCustomerMapperTest
 *
 * @package Tests\Unit\AppBundle\Model\Systems\Impl\Shipstation\Mapper
 */
final class ShipstationUpdatedCustomerMapperTest extends ConnectorTestCaseAbstract
{
    ...
    {
        $connector = $this->ownContainer->get('hbpf.custom_node.shipstation-updated-customer-mapper');
