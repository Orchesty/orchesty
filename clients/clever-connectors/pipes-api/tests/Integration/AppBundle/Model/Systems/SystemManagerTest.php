...
final class SystemManagerTest extends DatabaseTestCaseAbstract
{
    ...
    public function testUninstallSystem(): void
    {
        ...
        $this->assertNotEmpty($this->dm->getRepository(MapTemplate::class)->findBy(['systemInstall' => $system->getId()]));
        $this->assertNotEmpty($this->dm->getRepository(DataLayout::class)->findBy(['systemInstall' => $system->getId()]));
