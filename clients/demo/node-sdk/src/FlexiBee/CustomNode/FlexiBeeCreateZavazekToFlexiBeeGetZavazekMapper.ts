import { IOutput as ICreateOutput } from '@orchesty/connector-flexi-bee/dist/Connector/FlexiBeeCreateZavazekConnector';
import { IInput as IGetInput } from '@orchesty/connector-flexi-bee/dist/Connector/FlexiBeeGetZavazekConnector';
...
export const NAME = `${FLEXI_BEE_APPLICATION}-create-zavazek-to-${FLEXI_BEE_APPLICATION}-get-zavazek-mapper`;

export default class FlexiBeeCreateZavazekToFlexiBeeGetZavazekMapper extends ACommonNode {
