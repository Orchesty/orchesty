...
export function UsageStatsUsersRowsInnerFromJSON(
  json: any
): UsageStatsUsersRowsInner {
  return UsageStatsUsersRowsInnerFromJSONTyped(json, false);
}

export function UsageStatsUsersRowsInnerFromJSONTyped(
  json: any,
  ...
  return {
    ...
    endUserDisplayId: !exists(json, "endUserDisplayId")
      ? undefined
      : json["endUserDisplayId"],
...
export function UsageStatsUsersRowsInnerToJSON(
  value?: UsageStatsUsersRowsInner | null
): any {
  if (value === undefined) {
    return undefined;
  }
