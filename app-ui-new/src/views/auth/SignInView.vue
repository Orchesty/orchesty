...
<template>
  <AuthLayout>
    ...
    <form class="mt-4 space-y-4 sm:mt-6 sm:space-y-6" @submit.prevent="handleSubmit">
      ...
      <div class="space-y-3">
        ...
        <Button variant="outline" class="w-full" @click="handleSocialLogin('Apple')">
          <template #prepend>
            <svg class="mr-2 h-5 w-5 text-gray-900 dark:text-white" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
