...
import {
  DeleteUsersResult,
  ListTenantsResult, Tenant, UserRecord,
...
export function generateUsersExport(name = 'neco') {
  return {
    uid: 'BjDKHoIseJR5zd0bixYnRR6Dt9i2',
    email: 'neco@neco.com',
    emailVerified: false,
...
export function generateTenantsExport(name = 'neco') {
  return {
    tenantId: 't1234',
    displayName: name || null,
    emailSignInConfig: {
...
export function getJWTToken(withPermissions = false) {
  return {
    authorization: sign({
