...
final class CloudLimitsHandlerTest extends TestCase
{
    ...
    /**
     * Verifies that resources in the BAND_NONE state are skipped and storage limits are converted from GB to MB.
     */
    public function testBandsToReportSkipsNoneAndConvertsStorageLimit(): void
    {
        $usage = [
            ...
            'percent' => ['messages' => 95.0, 'slots' => NULL, 'storage' => 39.1],
    ...
    /**
     * Verifies that the storage limit is converted from GB to MB in the bands report.
     */
    public function testBandsToReportConvertsStorageLimitToMb(): void
    {
        $usage = [
            ...
            'percent' => ['messages' => NULL, 'slots' => NULL, 'storage' => 102.5],
