 ...
 * }
 * @psalm-type HbPfCommonsConfig = array<mixed>
 * @psalm-type HbPfAclConfig = array<mixed>
 * @psalm-type HbPfApiGatewayConfig = array<mixed>
 * @psalm-type HbPfConfiguratorConfig = array<mixed>
 * @psalm-type HbPfLogsConfig = array{
 *     type: "mongodb"|Param,
 *     storage_name: scalar|null|Param, // Set name of mongodb database.
 * }
 * @psalm-type HbPfMetricsConfig = array{
 *     metrics?: array<mixed>,
 * }
 * @psalm-type HbPfUsageStatsConfig = array<mixed>
 * @psalm-type HbPfUserConfig = array<mixed>
 * @psalm-type HbPfUsersConfig = array{
 *     user?: array<mixed>,
 * }
 * @psalm-type HbPfUserTaskConfig = array<mixed>
 * @psalm-type RabbitMqConfig = array{
 *     client_factory?: scalar|null|Param, // Default: "RabbitMqBundle\\Connection\\ClientFactory"
 *     connection_manager?: scalar|null|Param, // Default: "RabbitMqBundle\\Connection\\ConnectionManager"
 *     consumer?: scalar|null|Param, // Default: "RabbitMqBundle\\Consumer\\Consumer"
 *     async_consumer?: scalar|null|Param, // Default: "RabbitMqBundle\\Consumer\\AsyncConsumer"
 *     consumer_command?: scalar|null|Param, // Default: "RabbitMqBundle\\Command\\ConsumerCommand"
 *     async_consumer_command?: scalar|null|Param, // Default: "RabbitMqBundle\\Command\\AsyncConsumerCommand"
 *     publisher?: scalar|null|Param, // Default: "RabbitMqBundle\\Publisher\\Publisher"
 *     logger?: scalar|null|Param, // Default: null
 *     configurator?: scalar|null|Param, // Default: "RabbitMqBundle\\Connection\\Configurator"
 *     connections?: array<string, array{ // Default: []
 *         dsn: scalar|null|Param,
 *     }>,
 *     queues?: array<string, array{ // Default: []
 *         durable?: bool|Param, // Default: false
 *         exclusive?: bool|Param, // Default: false
 *         auto_delete?: bool|Param, // Default: false
 *         passive?: bool|Param, // Default: false
 *         no_wait?: bool|Param, // Default: false
 *         arguments?: list<scalar|null|Param>,
 *         bindings?: list<array{ // Default: []
 *             exchange: scalar|null|Param,
 *             routing_key?: scalar|null|Param, // Default: ""
 *             no_wait?: scalar|null|Param, // Default: false
 *             arguments?: list<scalar|null|Param>,
 *         }>,
 *     }>,
 *     exchanges?: array<string, array{ // Default: []
 *         type?: "direct"|"topic"|"fanout"|Param,
 *         durable?: bool|Param, // Default: false
 *         auto_delete?: bool|Param, // Default: false
 ...
 *         }>,
 *     }>,
 *     publishers?: array<string, array{ // Default: []
 *         class?: scalar|null|Param, // Default: "RabbitMqBundle\\Publisher\\Publisher"
 *         connection?: scalar|null|Param, // Default: "default"
 *         exchange?: scalar|null|Param, // Default: ""
 *         routing_key?: scalar|null|Param, // Default: ""
 *         mandatory?: bool|Param, // Default: false
 *         immediate?: bool|Param, // Default: false
 *         persistent?: bool|Param, // Default: false
 *         acknowledge?: bool|Param, // Default: false
 *     }>,
 *     consumers?: array<string, array{ // Default: []
 *         class?: scalar|null|Param, // Default: "RabbitMqBundle\\Consumer\\Consumer"
 *         connection?: scalar|null|Param, // Default: "default"
 *         queue: scalar|null|Param,
 *         callback: scalar|null|Param,
 *         consumer_tag?: scalar|null|Param, // Default: ""
 *         async?: bool|Param, // Default: false
 *         no_local?: bool|Param, // Default: false
 *         no_ack?: bool|Param, // Default: false
 *         exclusive?: bool|Param, // Default: false
 *         no_wait?: bool|Param, // Default: false
 *         prefetch_count?: scalar|null|Param, // Default: 0
 *         prefetch_size?: scalar|null|Param, // Default: 0
 *         tick_method?: scalar|null|Param, // Default: null
 *         tick_seconds?: scalar|null|Param, // Default: null
 *         max_messages?: scalar|null|Param, // Default: null
 *         max_seconds?: scalar|null|Param, // Default: null
 *         arguments?: list<scalar|null|Param>,
 *     }>,
 * }
 * @psalm-type RestConfig = array{
 *     strict?: bool|Param, // Default: false
 *     routes?: list<list<scalar|null|Param>>,
 *     decoders?: list<scalar|null|Param>,
 *     cors?: list<array{ // Default: []
 *         origin?: list<scalar|null|Param>,
 *         methods?: list<scalar|null|Param>,
 *         headers?: list<scalar|null|Param>,
 *         credentials?: bool|Param,
 *     }>,
 *     security?: list<array{ // Default: []
 *         X_Frame_Options?: scalar|null|Param,
 *         X_XSS_Protection?: scalar|null|Param,
 *         X_Content_Type_Options?: scalar|null|Param,
 *         Content_Security_Policy?: scalar|null|Param,
 *         Strict_Transport_Security?: scalar|null|Param,
 *         Referrer_Policy?: scalar|null|Param,
 *         Feature_Policy?: scalar|null|Param,
 *         Expect_CT?: scalar|null|Param,
 *     }>,
 * }
 * @psalm-type HbPfEnterpriseApiGatewayConfig = array<mixed>
 * @psalm-type HbPfMcpConfig = array<mixed>
 ...
 *     hb_pf_acl?: HbPfAclConfig,
 *     hb_pf_api_gateway?: HbPfApiGatewayConfig,
 *     hb_pf_configurator?: HbPfConfiguratorConfig,
 *     hb_pf_logs?: HbPfLogsConfig,
 *     hb_pf_metrics?: HbPfMetricsConfig,
 *     hb_pf_usage_stats?: HbPfUsageStatsConfig,
 *     hb_pf_user?: HbPfUserConfig,
 *     hb_pf_users?: HbPfUsersConfig,
 *     hb_pf_user_task?: HbPfUserTaskConfig,
 *     rabbit_mq?: RabbitMqConfig,
 *     rest?: RestConfig,
 *     hb_pf_enterprise_api_gateway?: HbPfEnterpriseApiGatewayConfig,
 *     hb_pf_mcp?: HbPfMcpConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
