    ...
    it("should receive messages and count them properly when all succeeded", (done) => {
        const events: Array<[{}, {}]> = [
            ...
            [
                ...
                {
                    headers: {
                        pf_correlation_id: "corrid1",
                        pf_process_id: "test_job_123",
                        pf_parent_id: "",
                        pf_sequence_id: "1",
                        pf_node_id: "test_node_1",
                        pf_node_name: "test_node_name_1",
                    },
                },
            ],
            [
                ...
                {
                    headers: {
                        pf_correlation_id: "corrid2",
                        pf_process_id: "test_job_123",
                        pf_parent_id: "",
                        pf_sequence_id: "1",
                        pf_node_id: "test_node_2",
                        pf_node_name: "test_node_name_2",
                    },
                },
            ],
            [
                ...
                {
                    headers: {
                        pf_correlation_id: "corrid3",
                        pf_process_id: "test_job_123",
                        pf_parent_id: "",
                        pf_sequence_id: "1",
                        pf_node_id: "test_node_3",
                        pf_node_name: "test_node_name_3",
                    },
                },
            ],
            ...
            [
                ...
                {
                    headers: {
                        pf_correlation_id: "corrid4",
                        pf_process_id: "test_job_789",
                        pf_parent_id: "",
                        pf_sequence_id: "1",
                        pf_node_id: "test_node_4",
                        pf_node_name: "test_node_name_4",
                    },
                },
            ],
        ];
