...
export const NAME = 'ecomail-send-transactional-email';
...
export default class EcomailSendTransactionalEmailConnector extends AConnector {
    ...
    public async processAction(dto: ProcessDto<IInput>): Promise<ProcessDto<IOutput>> {
        ...
        checkParams(input as unknown as Record<string, unknown>, ['template_id', 'subject', 'from_name', 'from_email', 'to']);
