...
export const NAME = 'limit-overflow-email-mapper';
...
export default class LimitOverflowEmailMapper extends ASystemEmailMapper {
    ...
    public async processAction(dto: ProcessDto<IPayload>): Promise<ProcessDto<IInput>> {
        ...
        const message = event.message ?? 'Limit overflow detected';
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden">
        ...
        <tr>
          <td style="padding:40px">
            <h2 style="margin:0 0 16px;color:#111827;font-size:20px;font-weight:600">Limit Overflow Alert</h2>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;border:1px solid #e5e7eb;border-radius:6px;overflow:hidden">
              ...
              <tr>
                ...
                <td style="padding:12px 16px;border-bottom:1px solid #e5e7eb;color:#dc2626;font-size:14px;font-weight:500">${currentValue.toLocaleString()} ${esc(unit)}</td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding:12px 16px;background-color:#f9fafb;color:#6b7280;font-size:13px">Discarded Messages</td>
            ...
            <p style="margin:0;color:#9ca3af;font-size:12px;line-height:1.5">
              This is an automated notification from Orchesty. Messages are being discarded because a configured limit has been exceeded. Please review your resource usage or plan limits.
            </p>
          </td>
        </tr>
      </table>
