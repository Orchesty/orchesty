...
export default class CloudLimitThresholdEmailMapper extends ASystemEmailMapper {
      ...
      <tr><td style="padding:40px">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;border:1px solid #e5e7eb;border-radius:6px;overflow:hidden">
          ...
          <tr>
            ...
            <td style="padding:12px 16px;border-bottom:1px solid #e5e7eb;color:${accentColor};font-size:14px;font-weight:600">${percent ? `${percent.toFixed(1)}%` : '—'}</td>
          </tr>
          <tr>
            <td style="padding:12px 16px;background-color:#f9fafb;border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px">Current</td>
            <td style="padding:12px 16px;border-bottom:1px solid #e5e7eb;color:#111827;font-size:14px">${current.toLocaleString()}</td>
          </tr>
          <tr>
            <td style="padding:12px 16px;background-color:#f9fafb;color:#6b7280;font-size:13px">Limit</td>
            <td style="padding:12px 16px;color:#111827;font-size:14px">${limit.toLocaleString()}</td>
          </tr>
        </table>
