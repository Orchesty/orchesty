...
export const NAME = 'restore-access-email-mapper';
...
export default class RestoreAccessEmailMapper extends ASystemEmailMapper {
    ...
    <td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden">
        ...
        <tr>
          <td style="padding:40px">
            ...
            <p style="margin:0 0 24px;color:#4b5563;font-size:15px;line-height:1.6">
              Your access to the Orchesty instance has been restored by an administrator. You can sign in using your existing credentials.
            </p>
        ...
        return dto.setNewJsonData<IInput>({
            subject: 'Your Orchesty access has been restored',
