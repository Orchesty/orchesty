...
export default class TopologyFailedRepeatedlyEmailMapper extends ASystemEmailMapper {
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden">
        ...
        <tr>
          <td style="padding:40px">
            <h2 style="margin:0 0 16px;color:#991b1b;font-size:20px;font-weight:600">Repeated topology failures</h2>
            <p style="margin:0 0 24px;color:#4b5563;font-size:15px;line-height:1.6">
              Topology <strong>${esc(topologyName)}</strong> has failed multiple times within the last 10 minutes. Immediate attention is recommended.
            </p>
            <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;border:1px solid #e5e7eb;border-radius:6px;overflow:hidden">
              <tr>
                <td style="padding:12px 16px;background-color:#fef2f2;border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px;width:140px">Topology</td>
              ...
              <tr>
                <td style="padding:12px 16px;background-color:#fef2f2;border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px">Latest Run ID</td>
                <td style="padding:12px 16px;border-bottom:1px solid #e5e7eb;color:#111827;font-size:13px;font-family:monospace">${esc(runId)}</td>
              </tr>
              <tr>
                <td style="padding:12px 16px;background-color:#fef2f2;border-bottom:1px solid #e5e7eb;color:#6b7280;font-size:13px">NOK count</td>
                <td style="padding:12px 16px;border-bottom:1px solid #e5e7eb;color:#dc2626;font-size:14px;font-weight:600">${nokCount}</td>
              </tr>
              <tr>
                <td style="padding:12px 16px;background-color:#fef2f2;color:#6b7280;font-size:13px">Correlation ID</td>
                <td style="padding:12px 16px;color:#111827;font-size:13px;font-family:monospace">${esc(correlationId)}</td>
              </tr>
            </table>
            <p style="margin:0 0 8px;color:#6b7280;font-size:13px">
              Latest failure at: <strong>${esc(occurredAt)}</strong>
            </p>
