...
export default class InviteEmailMapper extends ACommonNode {
    ...
    public processAction(dto: ProcessDto<IInput>): ProcessDto<IOutput> {
        ...
        const inviteUrl = `${frontendUrl.replace(/\/+$/, '')}/accept-invite/${hash}`;
              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 0 24px">
                <tr>
                  <td style="background-color:#1a56db;border-radius:6px;padding:12px 32px">
                    <a href="${inviteUrl}" style="color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;display:inline-block">Accept Invitation</a>
                  </td>
                </tr>
              </table>
              <p style="margin:0 0 8px;color:#6b7280;font-size:13px">Or copy and paste this link into your browser:</p>
              <p style="margin:0 0 24px;color:#1a56db;font-size:13px;word-break:break-all">${inviteUrl}</p>
