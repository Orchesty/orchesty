...
function CustomRenderer(eventBus, styles, pathMap, canvas) {
  ...
  this.drawShape = (parentGfx, element) => {
    ...
    switch (pipesType) {
        ...
        case 'resequencer':
            let resequencerTask = this.bpmnRenderer.handlers['bpmn:Task'](parentGfx, element);

            let resequencerTaskPathData1 = this.pathMap.getScaledPath('PIPES_RESEQUENCER_1', {
                abspos: {x: 0, y: 0}
            });
            ...
            let resequencerTaskPathData2 = this.pathMap.getScaledPath('PIPES_RESEQUENCER_2', {
                abspos: {x: 0, y: 0}
            });
            ...
            let resequencerTaskPathData3 = this.pathMap.getScaledPath('PIPES_RESEQUENCER_3', {
                abspos: {x: 0, y: 0}
            });
        ...
        case 'debug':
            let debugTask = this.bpmnRenderer.handlers['bpmn:Task'](parentGfx, element);

            let debugTaskPathData1 = this.pathMap.getScaledPath('PIPES_DEBUG_1', {
                abspos: {x: 0, y: 0}
            });
            ...
            let debugTaskPathData2 = this.pathMap.getScaledPath('PIPES_DEBUG_2', {
                abspos: {x: 0, y: 0}
            });
            ...
            let debugTaskPathData3 = this.pathMap.getScaledPath('PIPES_DEBUG_3', {
                abspos: {x: 0, y: 0}
            });
