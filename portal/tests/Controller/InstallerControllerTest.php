...
final class InstallerControllerTest extends ControllerTestCaseAbstract
{
    ...
    public function testInstaller(): void
    {
        ...
        $this->assertEquals($this->getInstallerElasticsearchMongoTrue(), $response2->getContent()['message']);
     ...
     * @return string
     */
    private function getInstallerElasticsearchMongoTrue(): string
    {
...
';
     ...
     * @return string
     */
    private function getInstallerLogstashInfluxFalse(): string
    {
